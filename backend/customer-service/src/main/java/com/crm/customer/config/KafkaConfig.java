...
import com.crm.customer.event.CustomerTierChangedEvent;
...
public class KafkaConfig {
    ...
    public ConsumerFactory<String, Object> consumerFactory() {
        ...
        // ErrorHandlingDeserializer: message hỏng chỉ bị bỏ qua thay vì làm consumer kẹt lặp vô hạn
        props.put(ConsumerConfig.VALUE_DESERIALIZER_CLASS_CONFIG, ErrorHandlingDeserializer.class);
        props.put(ErrorHandlingDeserializer.VALUE_DESERIALIZER_CLASS, JsonDeserializer.class.getName());
        props.put(JsonDeserializer.TRUSTED_PACKAGES, "*");
        // Không đọc type header (event đến từ service khác, class không tồn tại ở đây)
        // nên phải khai kiểu mặc định để mọi payload JSON được đọc thành Map
